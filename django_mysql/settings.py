...
# Import sensitive information like username and passwords
...
SECRET_KEY = "+^m)#p7&a-kzpm0&kyx6$#7p9459z$sg@ge9&ag&5t9upxf!@-"
...
INSTALLED_APPS = [
    ...
    "temperaturemonitor.apps.TemperaturemonitorConfig",
]
